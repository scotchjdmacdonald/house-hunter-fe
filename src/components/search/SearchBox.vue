    ...
    <div class="search-box">
        <div class="search-container">
            <div class="select-input">
                ...
                <vs-select autocomplete placeholder="Select" class="inner-select"
            ...
            <div class="select-input-first">
                ...
                <vs-select placeholder="Select" class="inner-select"
                    v-model="minPrice" width="100px">
                    <vs-select-item :key="index" :value="item.value" :text="item.text" v-for="(item,index) in prices" />
                </vs-select>
            </div>
            <div class="select-input">
            ...
            <div class="select-input">
                ...
                <vs-select placeholder="Select" class="inner-select"
                    ...
                    <vs-select-item :key="index" :value="item.value" :text="item.text" v-for="(item,index) in bedrooms" />
                </vs-select>
            </div>
            <div class="select-input">
                ...
                <vs-select placeholder="Select" class="inner-select"
                    ...
                    <vs-select-item :key="index" :value="item.value" :text="item.text" v-for="(item,index) in sizes" />
                </vs-select>
            </div>
            <div class="search-button">
                <vs-button size="large" color="rgb(61, 220, 151)" type="filled" v-on:click="searchProperties">Search</vs-button>
            </div>
        </div>
    </div>
</template>
...
<script>
import { sizes, prices, bedrooms } from '@/constants/constants';
